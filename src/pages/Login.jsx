    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4">
      <div className="bg-white shadow-lg rounded-2xl p-8 w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-gray-400 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
        ...
        <div className="flex justify-between gap-3">
           <button  onClick={handleGoogleSignup} className="flex justify-center items-center gap-2 w-full border-1 border-gray-400 rounded-xl py-2 hover:bg-gray-50">
          ...
          <button onClick={handleGithubSignup} className="flex justify-center items-center gap-2 w-full border-1 border-gray-400 rounded-xl py-2 hover:bg-gray-50">
